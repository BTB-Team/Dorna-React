import img1 from "../assets/Hilal.webp";
import img2 from "../assets/Amovi logo showcase.webp";
import img3 from "../assets/Rahyar logo showcase.webp";
import img4 from "../assets/tanin logo showcase.webp";
import img5 from "../assets/Avan dokht logo showcase.webp";
import img6 from "../assets/cham cham english logo showcase.webp";
import img7 from "../assets/parsa decor logo showcase.webp";
import img8 from "../assets/BA logo showcase.webp";
import img9 from "../assets/estedad logo showcase.webp";
import React, { useState, useEffect } from "react";

// Branding Primary Data  
const projectData = [
  {
    id: 1,
    title: "Helal Petroleum",
    description:
...
const BrandProject = () => {
  ...
  const visibleProjects = isMobile
    ? showMore
      ? projectData
      : mobileProjects.map((id) => projectData.find((item) => item.id === id))
    : projectData;
