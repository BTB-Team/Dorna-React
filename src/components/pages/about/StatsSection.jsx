        ...
        <div className="relative mx-auto mt-12 w-full max-w-[1048px] bg-white border border-[#E6E6E6] rounded-[20px] overflow-hidden shadow-sm">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between px-6 sm:px-10 md:px-16 pt-10 gap-6">
            <div className="text-center lg:text-left">
              <h2 className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[36px] font-semibold fot-[Montserrat-semibold] leading-tight text-primary">
                Every Number Holds a Story
              </h2>
              <p className="mt-4 sm:mt-5 max-w-[760px] text-[15px] sm:text-[18px] font-[Montserrat-body] md:text-[20px] lg:text-[22px] leading-7 text-[#686767]">
